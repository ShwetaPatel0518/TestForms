...
public class Forms_Test {
	...
	public static void TC02_CreateNewForm() throws InterruptedException {
		...
		formTitle.clear();
		formTitle.sendKeys("Test Automation Form Created " + LocalDate.now().toString());
		Thread.sleep(1000);
	...
	public static void TC03_TestSearchAndOpenForm() throws InterruptedException {
		...
		searchElement.click();
		searchElement.sendKeys("Test Automationm v kl mb  wagmnv  Form Created ");
	...
	public static void TC04_AddNewTextQuestionToFormLayout(String questionType, String labelText, String helpText,
		...
		if(isCharsOnly == "true")
		{
		driver.findElement(By.xpath("//div[@id='allElements']//div[" + size + "]//iwe-checkbox[@input_id='letter']"))
				.click();
		}
		else
		{
			System.out.println("Only letters not checked");
		}

		driver.findElement(By.xpath("//div[@id='allElements']//div[" + size + "]//iwe-checkbox[@input_id='decimal']"))
				.click();

		driver.findElement(By.xpath("//div[@id='allElements']//div[" + size + "]//iwe-checkbox[@input_id='required']"))
				.click();
		// Save Question
		if (size == 1) {
